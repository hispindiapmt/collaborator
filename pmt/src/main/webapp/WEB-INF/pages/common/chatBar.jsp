	...
	<div class="chat-inner">
		...
		<div id="group-2" class="chat-group">
			<strong>Office</strong><a href="#"><span
				...
				class="badge badge-info is-hidden">0</span></a><a href="#"><span
				class="user-status is-offline"></span> <small>Sherman Stokes</small>
				<span class="badge badge-info is-hidden"> 0</span></a><a href="#"><span
				class="user-status is-offline"></span> <small>Florence
	...
	<div id="chat-box" style="top: 400px">
		...
		<div class="chat-content">
			<ul class="chat-box-body">
				<li>
					<p>
						<img src="../../resources/images/avatar/128.jpg" class="avt" /><span
							class="user">John Doe</span><span class="time">09:33</span>
					</p>
					<p>Hi Swlabs, we have some comments for you.</p>
				</li>
				<li class="odd">
					<p>
						<img src="../../resources/images/avatar/48.jpg" class="avt" /><span
							class="user">Swlabs</span><span class="time">09:33</span>
					</p>
