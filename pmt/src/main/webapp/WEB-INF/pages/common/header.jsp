	...
	$(document).ready(function(){
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					$("#currentUserFname").html(xmlhttp.responseText);					
			}
		}
		xmlhttp.open("POST", "/currentUser.html", true);
		xmlhttp.send();
	});
</script>

<div id="header-topbar-option-demo" class="page-header-topbar">
	<nav id="topbar" role="navigation" style="margin-bottom: 0; position:"
		...
		<div class="navbar-header">
			...
			<a id="logo" href='/index.html' class="navbar-brand"><span
				class="fa fa-rocket"></span><span class="logo-text">Collaborator</span><span
			...
			<ul class="nav navbar navbar-top-links navbar-right mbn">
				...
				<li class="dropdown topbar-user"><a data-hover="dropdown"
					href="#" class="dropdown-toggle"><img
						src="../../resources/images/avatar/48.jpg" alt=""
						class="img-responsive img-circle" />&nbsp;<span class="hidden-xs" id="currentUserFname">Robert
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
						eleifend et nisl eget porta. Curabitur elementum sem molestie nisl
						varius, eget tempus odio molestie. Nunc vehicula sem arcu, eu
						pulvinar neque cursus ac. Aliquam ultricies lobortis magna et
						aliquam. Vestibulum egestas eu urna sed ultricies. Nullam pulvinar
						dolor vitae quam dictum condimentum. Integer a sodales elit, eu
						pulvinar leo. Nunc nec aliquam nisi, a mollis neque. Ut vel felis
						quis tellus hendrerit placerat. Vivamus vel nisl non magna feugiat
						dignissim sed ut nibh. Nulla elementum, est a pretium hendrerit,
						arcu risus luctus augue, mattis aliquet orci ligula eget massa.
						Sed ut ultricies felis.</p>
				</div>
